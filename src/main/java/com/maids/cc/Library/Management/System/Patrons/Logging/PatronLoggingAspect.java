package com.maids.cc.Library.Management.System.Patrons.Logging;
...
public class PatronLoggingAspect {
    ...
    @Before("execution(* com.maids.cc.Library.Management.System.Patrons.*.*(..))")
    public void logMethodCall(JoinPoint joinPoint) {
        logger.info("Calling method: {} with arguments: {}", joinPoint.getSignature().getName(), Arrays.toString(joinPoint.getArgs()));
    }

    @After("execution(* com.maids.cc.Library.Management.System.Patrons.*.*(..))")
    public void logMethodExit(JoinPoint joinPoint) {
        logger.info("Method exited: {}", joinPoint.getSignature().getName());
    }

    @AfterThrowing(pointcut = "execution(* com.maids.cc.Library.Management.System.Patrons.*.*(..))", throwing = "exception")
    public void logMethodException(JoinPoint joinPoint, Throwable exception) {
        logger.error("Exception in method: {} with message: {}", joinPoint.getSignature().getName(), exception.getMessage());
    }

    @Around("execution(* com.maids.cc.Library.Management.System.Patrons.PatronController.add*(..)) || execution(* com.maids.cc.Library.Management.System.Patrons.PatronController.update*(..))")
